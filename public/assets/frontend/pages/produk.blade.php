                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="rounded position-relative fruite-item">
                                    <div class="fruite-img">
                                        <img src="{{ asset('assets/gambar/'.$p->gambar) }}"
                                            class="img-fluid rounded-top w-100" alt=""
                                            style=" height:15rem; object-fit:cover;">
                                    </div>
                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                        style="top: 10px; left: 10px;">Fruits</div>
                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom h-40">
                                        <div class="row">
                                            <div class="col-12">
                                                <h4>{{ $p->barang }}</h4>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-6 fw-bold mb-0">{{ $p->harga }} / kg</p>
                                                    <form action="/add_to_cart" method="post">
                                                        ...
                                                        <button type="submit" class="btn border border-secondary rounded-pill px-3 text-primary"><i
                                                            class="fa fa-shopping-bag me-2 text-primary"></i>Tambah</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
