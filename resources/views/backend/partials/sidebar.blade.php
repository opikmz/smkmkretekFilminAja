<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
            ...
            <span class="ms-1 font-weight-bold">Filmin Aja</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Data Film</h6>
            </li>
            {{-- Studio --}}
            <li class="nav-item">
                <a class="nav-link " href="/sutradara">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link " href="/pemeran">
                    ...
                    <span class="nav-link-text ms-1">Data Pemeran</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link " href="/movie">
                    ...
                    <span class="nav-link-text ms-1">Data Film</span>
                </a>
            </li>

            {{-- Cart --}}
            <li class="nav-item">
                <a class="nav-link " href="/admin_cart">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Data Keranjang</span>
                </a>
            </li>
            {{-- End Cart --}}
