                    ...
                    <div class="card-body px-0 ">
                        <div class="row">
                            <div class="col-lg-12 col-sm-6 center d-flex justify-content-center align-items-center">
                                <h3 class="font-weight-bolder">{{ $studio->studio }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer p-1 d-flex justify-content-end align-items-end">
                        <div class="px-2 "><a href="/destroy_studio/{{ $studio->id }}" class="text-danger font-weight-bold"> Hapus</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-xl-0 mb-4">
                <div class="card p-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <form method="POST" action="/update_studio/{{ $studio->id }}" >
                            @csrf
                            <label for="Pengarang">Studio</label>
                            <div class="mb-3">
                                <input type="text" class="form-control mb-2" placeholder="Masukan Studio..."
                                    aria-label="Pengarang" name="studio" value="{{ $studio->studio }}">
                            </div>
