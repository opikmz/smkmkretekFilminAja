                    ...
                    <div class="card-body px-0 ">
                        <div class="row">
                            <div class="col-lg-12 col-sm-6 center d-flex justify-content-center align-items-center">
                                <h3 class="font-weight-bolder">{{ $sutradara->sutradara }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer p-1 d-flex justify-content-end align-items-end">
                        <div class="px-2 "><a href="" onclick="konfirmasiHapus({{ $sutradara->id_sutradara }})" class="text-danger font-weight-bold"> Hapus</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-xl-0 mb-4">
                <div class="card p-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <form method="POST" action="/update_sutradara/{{ $sutradara->id_sutradara }}" >
                            @csrf
                            <label for="Pengarang">Sutradara</label>
                            <div class="mb-3">
                                <input type="text" class="form-control mb-2" placeholder="Masukan Sutradara..."
                                    aria-label="Pengarang" name="sutradara" value="{{ $sutradara->sutradara }}">
                            </div>
